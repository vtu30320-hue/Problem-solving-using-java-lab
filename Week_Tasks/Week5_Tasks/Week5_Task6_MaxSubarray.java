...
public class Week5_Task6_MaxSubarray {

    public static List<Integer> Week5_Task6_MaxSubarray(List<Integer> arr) {
    ...
    public static void main(String[] args) {
        ...
        while (t-- > 0) {
            ...
            List<Integer> result = Week5_Task6_MaxSubarray(arr);
